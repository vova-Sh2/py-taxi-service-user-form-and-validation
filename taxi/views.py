...
from .forms import DriversCreateForm, DriverLicenseUpdateForm, CarCreateForm
...
class DriversCreateView(LoginRequiredMixin, generic.CreateView):
    model = get_user_model()
    form_class = DriversCreateForm
